            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="../editar/editarCliente.php?id=<?php echo $tarefa['cpfCliente']; ?>"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="../remover/removerCliente.php?id=<?php echo $tarefa['cpfCliente']; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
					</tr>
					<?php endforeach; ?>
                    <!--Final-->
