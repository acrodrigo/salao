        ...
        <div clas="span10 offset1">
          <div class="card">
            <div class="card-header">
                <h3 class="well"> Adicionar Servico</h3>
            </div>
            <div class="card-body">
            <form class="form-horizontal" action="validarServico.php" method="post">
                ...
                <div class="control-group <?php echo !empty($comissaoErro)?'error ': '';?>">
                    ...
                    <div class="controls">
                        <input size="4" class="form-control" name="comissao" type="text" required="" value="<?php echo !empty($comissao)?$comissao: '';?>">
