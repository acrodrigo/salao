    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Gerenciamento Produtos</h2>
					</div>
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Adicioanr novo Produto</span></a>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="../editar/editarProduto.php?id=<?php echo $produto['idProduto']; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="../remover/removerProduto.php?id=<?php echo $produto['idProduto']; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
					<?php endforeach; ?>
                    <!--Final-->
			...
			<div class="modal-content">
				<form action="validarProduto.php" method="post">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							<label>Preço</label>
							<input class="form-control" name="preco" required>
                        </div>
                        <div class="form-group">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					...
					<div class="modal-body">					
						<p>Você realmente que remover este produto ?</p>
