...
<title>Tabela Edição de Serviços</title>
...
<body>
    ...
    <?php
        ...
        if($servico = buscar_servico($conexao, $_GET['id'])){
            ...
            echo $servico .' Chave invalida para Edicao';
            die();
        }
        ...
        <div clas="span10 offset1">
          <div class="card">
            <div class="card-header">
                <h3 class="well"> Editar Servico </h3>
            </div>
            <div class="card-body">
            <form class="form-horizontal" action="confirmarEdicaoServico.php" method="post">
			<div style="display:none;" class="control-group <?php echo !empty($nomeErro)?'error ': '';?>">
                    <label class="control-label">ID</label>
                    <div class="controls">
                        <input  size="45" class="form-control" name="idServico" type="text" value="<?php echo $servico['idServico']; ?>" >
                    </div>
                </div>
                <div class="control-group <?php echo !empty($nomeErro)?'error ': '';?>">
                    <label class="control-label">Nome</label>
                    <div class="controls">
                        <input size="45" class="form-control" name="nome" type="text" required="" value="<?php echo $servico['nome']; ?>">
                ...
                <div class="control-group <?php echo !empty($precoErro)?'error ': '';?>">
                    ...
                    <div class="controls">
                        <input size="11" class="form-control" name="preco" type="text" required="" value="<?php echo $servico['preco'];?>">
                ...
                <div class="control-group <?php echo !empty($comissaoErro)?'error ': '';?>">
                    ...
                    <div class="controls">
                        ...
                        <?php if(!empty($comissaoErro)): ?>
                            <span class="help-inline"><?php echo $comissaoErro;?></span>
                            <?php endif;?>
                    </div>
                </div>
