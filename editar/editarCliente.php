...
<div id="editEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form action="confirmarEdicaoCliente.php" method="post">
        ...
        <div clas="span10 offset1">
          <div class="card">
            <div class="card-header">
                <h3 class="well"> Editar Cliente </h3>
            </div>
            <div class="card-body">
            <form class="form-horizontal" action="confirmarEdicaoCliente.php" method="post">

                <div class="control-group <?php echo !empty($cpfErro)?'error ': '';?>">
                    <label class="control-label">CPF</label>
                    <div class="controls">
                        <input size="11" class="form-control" name="cpf" type="text" required="" value="<?php echo $cliente['cpfCliente']; ?>">
                ...
                <div class="control-group <?php echo !empty($nomeErro)?'error ': '';?>">
                    ...
                    <div class="controls">
                        <input size="45" class="form-control" name="nome" type="text" required="" value="<?php echo $cliente['nome']; ?>">
                ...
                <div class="control-group <?php echo !empty($telefoneErro)?'error ': '';?>">
                    ...
                    <div class="controls">
                        <input size="11" class="form-control" name="telefone" type="text" required="" value="<?php echo $cliente['telefone1'];?>">
